...
startTime = Sys.time()
setwd("S:\\Biostats\\BIO-STAT\\Koestler Devin\\GRAs\\Richard Meier\\Dissertation\\new_sims")
...
while(rerun){
p0A = runif(4, min=0.85, max=0.95)
p0B = runif(4, min=0.85, max=0.95)
...
outpath = paste0("sim_bernP0_ufrgC_","n",each_num,"_T",TCONC*100,"_delta",delta*10,"_grps4_pe.Rdata")
